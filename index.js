...
function displayKembalian(uangPembeli, totalBeli, isGetDiscount, hargaBuku, totalHarga) {
  console.log('*break;');
...
function displayNota(isGetDiscount, jumlahBukuDibeli, hargaBuku, nilaiPercentPajak) {
  if (isGetDiscount) {
    ...
    displayKembalian(uangPembeli, jumlahBukuDibeli, isGetDiscount, priceBookWithTaxDiscount, totalPriceWithDiscountTax);
  } else {
    const taxAmmount = (hargaBuku * nilaiPercentPajak) / 100;
    ...
    displayKembalian(uangPembeli, jumlahBukuDibeli, isGetDiscount, taxPrice, totalPrice);
  }
}

function BookPurchasing(dataBuku, namaBukuBeli, uangPembeli, jumlahBeliBuku, nilaiPercentDiscount, nilaiPercentPajak) {
  ...
  if (dataBuku == undefined) {
    ...
    if (!isHasBook) {
      ...
      if (!isEnoughMoney) {
        ...
        console.log(`Harga Buku: ${dataBuku[indexOfBook].hargaBuku}`);
          ...
          if (i <= jumlahBeliBuku) {
            ...
            if (i == dataBuku[indexOfBook].stockBuku) {
              if (jumlahBeliBuku > dataBuku[indexOfBook].stockBuku) {
                ...
                console.log('=====================');
                displayNota(isGetDiscount, dataBuku[indexOfBook].stockBuku, dataBuku[indexOfBook].hargaBuku, nilaiPercentPajak);
              }
            }
            if (i == jumlahBeliBuku) {
              displayNota(isGetDiscount, jumlahBeliBuku, dataBuku[indexOfBook].hargaBuku, nilaiPercentPajak);
...
const uangPembeli = 300000;
const jumlahBeliBuku = 13;
const nilaiPercentDiscount = 20;
const nilaiPercentPajak = 10;
// console.log(dataBukuJSON);
// console.log('*Break;');
BookPurchasing(dataBukuJSON, namaBukuBeli, uangPembeli, jumlahBeliBuku, nilaiPercentDiscount, nilaiPercentPajak);
// console.log('*Break;');
// console.log(dataBukuJSON);
